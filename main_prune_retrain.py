"""Hard-code L1 pruning on a trained model and continue training (for QM9 only). Will call qm9.train_prune_retrain."""
...
if __name__ == "__main__":
    ...
    # Select dataset.
    if args.dataset == "qm9":
        from qm9.train_prune_retrain import train_prune_retrain
        task = "graph"
    ...
    if args.gpus == 0:
        ...
        args.mode = 'cpu'
        train_prune_retrain(0, model, args)
    elif args.gpus == 1:
        ...
        mp.spawn(train_prune_retrain, nprocs=args.gpus, args=(model, args,))
